...
# Written by Janet Harwood September 6th.
# made generic , to process mouse gene subsets to Magma format
# pheno_ID tab space delimited gene list
# edited for hbp gene set automation Novemeber 13th 2017.
