...
# Written by Janet Harwood May 31st 2017. Finished, tested, complete.
# this script processes multiple 'tree' files from the same directory and outputs the paths derived from them and updates
# the attribute file with  the 'levels' from the paths.
# Ran though pylint July 18th 2017.
