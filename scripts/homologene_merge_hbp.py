...
# Written by Janet Harwood July 27th.
# To get the one_to_one,one_to_many,many_to_one, many_to_many relationships from the human and mouse a) all genes minus pseudo genes
# and b) protein coding genes in homologene.

# re-written, checked, finished.
