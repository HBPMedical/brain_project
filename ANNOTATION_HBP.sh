...
# GO_EVIDENCE GO_PATHS GO_TREES HOMOLOGENE GENE_SETS MP_ANNOTATIONS \
...
#
# cd $root_dir/processed/GENE_SETS/MAMMALIAN_PHENOTYPE
#
...
#
# del_dir_list=(MP_ID_MAPPING GO_ATTRIBUTES	HOMOLOGENE GO_ATTRIBUTES_UPDATED
